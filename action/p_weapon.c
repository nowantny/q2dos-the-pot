...
void DropExtraSpecial( edict_t* ent )
{
        ...
        if ( ent->client->pers.inventory[ITEM_INDEX(FindItem(SNIPER_NAME))] > 0 
                ...
                gi.dprintf(DEVELOPER_MSG_GAME, "Couldn't find the appropriate weapon to drop.\n");
...
//FIREBLADE
        ...
        if( ent->client->weaponstate == WEAPON_RELOADING)
        {
                ...
                else if(ent->client->ps.gunframe < FRAME_RELOAD_LAST)
                {
                        ...
                        default:
                                gi.dprintf(DEVELOPER_MSG_GAME, "No weapon choice for reloading (sounds).\n");
                                break;
                        }
                }
                else
                {
                        ...
                        default:
                                gi.dprintf(DEVELOPER_MSG_GAME, "No weapon choice for reloading.\n");
                                break;
                        }
        ...
        if (ent->client->weaponstate == WEAPON_ACTIVATING)
        {
                ...
                default:
                        gi.dprintf(DEVELOPER_MSG_GAME, "Activated unknown weapon.\n");
                        break;
                }
