...
extern void Com_sprintf ( char * dest , int size , char * fmt , ... ) __attribute__((__format__(__printf__,3,4)));
...
extern char * va ( char * format , ... ) __attribute__((__format__(__printf__,1,2)));
...
extern void Com_Printf ( char * msg , ... ) __attribute__((__format__(__printf__,1,2)));
extern void Sys_Error ( char * error , ... ) __attribute__((__format__(__printf__,1,2)));
